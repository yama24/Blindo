		...
		<center>
			<div class="col-md-7">
				...
				<?php } else { ?>
					...
					<?php endforeach; ?>
					<p>Jika sudah melakukan pembayaran, silakan melakukan konfirmasi pembayaran <a href="<?= base_url(); ?>payment/confirmation" class="btn btn-info btn-sm">dengan klik disini</a></p>
					<p>Terima Kasih</p>
